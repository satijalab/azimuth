...
```{r pbmc_annotate, message=FALSE, warning=FALSE, results='hide'}
...
```{r pbmc_annotate_2, message=FALSE, warning=FALSE, results='hide'}
pbmc.2 <- RunAzimuth(query = "/brahms/hartmana/run_azimuth_data/10k_PBMC_3p_nextgem_Chromium_X_filtered_feature_bc_matrix.h5", reference = "pbmcref")
```
