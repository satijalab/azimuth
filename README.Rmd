...
We have made an instance of the app available for public use, [described here](https://satijalab.org/azimuth).
...
You can download the PBMC reference files that would be automatically loaded by default using the following command:
```
