...
`r pkg` is a Shiny app demonstrating a query-reference mapping algorithm for single-cell data. The reference data accompanying the app and the algorithms used are described in the publication "Integrated analysis of multimodal single-cell data" (Y. Hao, S. Hao, et al., bioRxiv 2020).

We have made an instance of the app available for public use, [described here](satijalab.org/azimuth).

All the analysis and visualization functionality available in the app - and much more - is available in version 4 of the the [Seurat R package](satijalab.org/seurat).
